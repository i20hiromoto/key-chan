  ...
  <form onSubmit={handleLogin} className="w-full max-w-md">
    ...
    <div className="mt-4">
      <CardFooter className="flex justify-between">
        <Button type="submit" className='w-[100px]'>登録</Button>
        <Button onClick={back} type="button" className='w-[100px]'>戻る</Button>
      </CardFooter>
    </div>
    <div>
      <CardFooter className="flex justify-between">
        <Button onClick={readIC} type="button" className='w-[150px]'>ICカード読み込み</Button>
      </CardFooter>
    </div>
  </form>
  <Title/>
